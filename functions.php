...
function my_script_init() 
{
	...
	// js
	wp_enqueue_script('', get_template_directory_uri() . '/js/script.js', array( 'jquery' ), filemtime( get_theme_file_path( 'js/script.js' )), true);
}
...
function get_main_image() {
	...
	return '<img src="' . get_template_directory_uri(). '/images/page-top-img01.png" />';
	endif;
}
